...
ADMIN_HELP_TEXT = (
    ...
    "🏆 <b>Kampaniya Liderliyi Əmrləri:</b>\n"
    "• /camp_start — Bütün kampaniya xallarını sıfırlayır və yeni yarışmanı başladır.\n"
    "• /camp_reset — /camp_start ilə eynidir (alternativ əmr).\n"
    "• /camp_top — Cari kampaniyada ən çox xal yığan Top-10 istifadəçini göstərir.\n\n"
